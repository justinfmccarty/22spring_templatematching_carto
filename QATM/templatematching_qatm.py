# -*- coding: utf-8 -*-
"""TemplateMatching_QATM.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ar9DY7fH8w8KHbXhafo8jSv7niwiC8ip
"""
...
#scores, w_array, h_array, thresh_list = run_one_sample(model, dataset,)
...
allscore = sum(scores)
plt.imshow(allscore)
# Only shows value>0.6
'''scorenew = scores[0]
mask = scorenew<0.0035
scorenew[mask] = 0
plt.imshow(scorenew)
